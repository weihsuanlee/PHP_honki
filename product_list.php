...
<div class="container-fluid mt-5">
    <div class="row">
        <div class="col-3 col-sm-3 col-md-2 categories-side-bar ml-auto">
            <!-- 分類選單 -->
            <div class="btn-group-vertical w-100 mr-auto">
                            ...
                            <a href="product_page.php?sid=<?= $r['sid'] ?>">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <p class="card-text">$ <?= $r['final_price'] ?></p>
                                    </div>
                                </div>
                            </a>
            ...
            <div class="row">
                <div class="col d-flex justify-content-center">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            <li class="page-item <?= $page == 1 ? 'diabled' : '' ?>">
                                <a class="page-link" href="?<?= $params['page'] = $page - 1;
                            ...
                            ?>
                                <li class="page-item <?= $i === $page ? 'active' : '' ?>">
                                    <a href="?<?= http_build_query($params) ?>" class="page-link"><?= $i ?></a>
                                </li>
                            <?php endfor; ?>
                            <li class="page-item <?= $page == $totalPages ? 'diabled' : '' ?>">
